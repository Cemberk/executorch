...
# Example script for exporting simple models to flatbuffer with HIP delegate.

import argparse
import pathlib

import torch
from executorch.backends.hip.hip_backend import HipBackend
...
# Script to export a model with HIP (AMD GPU) delegation.
...
def main():
    ...
    partitioner = HipPartitioner(
        [HipBackend.generate_method_name_compile_spec(args.model_name)]
    )
